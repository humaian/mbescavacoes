...
$c_body = ( isset( $ish_options['body_color'] ) && '' != $ish_options['body_color'] ) ? $ish_options['body_color'] : ISH_BODY_COLOR;
$c_background = ( isset( $ish_options['background_color'] ) && '' != $ish_options['background_color'] ) ? $ish_options['background_color'] : ISH_BACKGROUND_COLOR;
...
$images_path = IYB_HTML_URI . '/images';
...
* Headlines
*/
.tp-caption h1, .tp-caption .h1, .tp-caption[class*="<?php echo THEME_SLUG; ?>_big_"] {
...
.tp-caption h2, .tp-caption .h2,  .tp-caption[class*="<?php echo THEME_SLUG; ?>_medium_"] {
...
.tp-caption h3, .tp-caption .h3,  .tp-caption[class*="<?php echo THEME_SLUG; ?>_small_"] {
