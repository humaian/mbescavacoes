...
class Ishyoboy_Dribbble_Widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        <?php if (!isset($ish_options) || !isset($ish_options['dribbble_access_token']) || '' == $ish_options['dribbble_access_token']){ ?>
        <p>
...
add_action( 'wp_ajax_ishyoboy_get_dribbble_shots', Array( &$this , 'ishyoboy_get_dribbble_shots' ) );
add_action( 'wp_ajax_nopriv_ishyoboy_get_dribbble_shots', Array( &$this , 'ishyoboy_get_dribbble_shots' ) );
