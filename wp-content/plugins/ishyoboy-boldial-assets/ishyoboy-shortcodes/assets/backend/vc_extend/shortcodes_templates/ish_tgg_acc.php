...
// Global variables
global $ish_options, $ish_tgg_options, $ish_tgg_items_count, $ish_tgg_count;

// Initialize value
if ( ! isset( $ish_tgg_count ) ) {
	$ish_tgg_count = 0;
}

$ish_tgg_count++;
$ish_tgg_items_count = 0;
...
// Replace the ##ISH_TGGS## code with current tabs order
$content = ( $ish_tgg_count > 1 ) ? str_replace( '##ISH_TGGS##', 'tgg-' . $ish_tgg_count . '-', $content) : str_replace( '##ISH_TGGS##', '', $content);
